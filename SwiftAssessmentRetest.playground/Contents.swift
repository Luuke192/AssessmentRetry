...
// Type inference is when you are telling the IDE which type a constant or variable is. This is represented like "let str: String = "....". The : String is inferring the data is a type of string.
...
/*func findState () {
    var key = ""
    if key == dictionaryState {
        print(dictionaryState)
    } else {
        print("This state is not available.")
    }
}*/
